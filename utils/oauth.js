  ...
  new Strategy(
    {
      ...
      callbackURL: `http://${process.env.HOST}:${process.env.PORT}/user/auth/fbSignIn/redirect`,
  ...
  new LinkedInStrategy(
    {
      ...
      callbackURL: `http://${process.env.HOST}:${process.env.PORT}/user/auth/LinkedIn/redirect`,
