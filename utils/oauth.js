  ...
  new Strategy(
    {
      ...
      callbackURL: `http://${process.env.DB_HOST}:${process.env.PORT}/user/auth/fbSignIn/redirect`,
  ...
  new LinkedInStrategy(
    {
      ...
      callbackURL: `http://${process.env.DB_HOST}:${process.env.PORT}/user/auth/LinkedIn/redirect`,
